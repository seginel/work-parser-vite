var Ee=Object.defineProperty,ke=Object.defineProperties;var we=Object.getOwnPropertyDescriptors;var J=Object.getOwnPropertySymbols;var Ce=Object.prototype.hasOwnProperty,ye=Object.prototype.propertyIsEnumerable;var Q=(e,t,o)=>t in e?Ee(e,t,{enumerable:!0,configurable:!0,writable:!0,value:o}):e[t]=o,F=(e,t)=>{for(var o in t||(t={}))Ce.call(t,o)&&Q(e,o,t[o]);if(J)for(var o of J(t))ye.call(t,o)&&Q(e,o,t[o]);return e},W=(e,t)=>ke(e,we(t));import{R as ee,j as U,r,o as Se,h as ve,J as De,p as Ie,B as Oe,a as Ne,b as Fe,c as Re}from"./vendor.b090e38c.js";const Te=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const u of document.querySelectorAll('link[rel="modulepreload"]'))n(u);new MutationObserver(u=>{for(const i of u)if(i.type==="childList")for(const c of i.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&n(c)}).observe(document,{childList:!0,subtree:!0});function o(u){const i={};return u.integrity&&(i.integrity=u.integrity),u.referrerpolicy&&(i.referrerPolicy=u.referrerpolicy),u.crossorigin==="use-credentials"?i.credentials="include":u.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(u){if(u.ep)return;u.ep=!0;const i=o(u);fetch(u.href,i)}};Te();const K=ee.createContext({visibility:!1,setVisibility:e=>{}}),s=U.exports.jsx,h=U.exports.jsxs,P=U.exports.Fragment,Ae=()=>{const{visibility:e,setVisibility:t}=r.exports.useContext(K);return h("div",{children:[s("label",{htmlFor:"visibility",children:"\u041F\u043E\u043A\u0430\u0437\u044B\u0432\u0430\u0442\u044C \u0432\u0430\u043B\u0438\u0434\u043D\u044B\u0435 \u043F\u0440\u043E\u0432\u0435\u0440\u043A\u0438"}),s("input",{id:"visibility",type:"checkbox",checked:e,onChange:o=>{t(o.target.checked)}})]})};let L;async function ze(){L=await Se("my-db",1,{upgrade(e){e.createObjectStore("images")}})}var M;(function(e){e.images="images"})(M||(M={}));var j;(function(e){e.first="first",e.second="second"})(j||(j={}));const te=(e,t)=>{const[o,n]=r.exports.useState(),[u,i]=r.exports.useState();return r.exports.useEffect(()=>{async function c(){if(!e)return;const l=Object.keys(e.files).filter(p=>e.files[p].dir?!1:p.includes(t)),[f,...a]=await Promise.all([e.files["index.html"].async("text"),...l.map(p=>e.files[p].async("text"))]);n(f),i(a.join(""))}c()},[n,i,e]),{html:o,css:u}},z=(e,t,o)=>`${e}-${t}-${o}`;var b;(function(e){e[e.min=1100]="min",e[e.max=1600]="max"})(b||(b={}));const Be=(e,t,o)=>{const[n,u]=r.exports.useState(!0),[i,c]=r.exports.useState(!1);return r.exports.useEffect(()=>{async function l(){const f=await L.getAllKeys(M.images);c(t.every(a=>f.includes(z(e,a,b.min))&&f.includes(z(e,a,b.max)))),u(!1)}l()},[o,t,e]),{contains:i,loading:n}},G=r.exports.memo(r.exports.forwardRef(({html:e,onLoad:t,width:o},n)=>s("iframe",{ref:n,style:{width:`${o}px`,minHeight:"100vh",border:"none"},id:"myiframe",srcDoc:e,onLoad:t}))),H=(e=100)=>new Promise((t,o)=>{setTimeout(()=>{t()},e)});async function V(e,t,o){return e?await Promise.all(o.map(async n=>{const u=e.querySelector(`.${n}`),i=await ve(u,{useCORS:!0,scale:1});return{className:n,image:i,targetWidth:t}})):[]}const We=`
...
`,Y=(e="",t="",o="")=>{const n=new DOMParser().parseFromString(e,"text/html"),u=n.createElement("style");return u.innerHTML=`${We} ${t} ${o}`,n.head.appendChild(u),Array.from(n.head.querySelectorAll("link")).forEach(c=>c.remove()),n.documentElement.outerHTML.replaceAll(/\.{0,2}\/?images/g,"/work-parser-vite/images")},oe=`
* {
