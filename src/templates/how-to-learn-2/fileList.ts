export const SECOND_WORK_CSS_FILES = [
    ...
    'blocks/techniques/__cards/techniques__cards.css',
    'blocks/techniques/techniques.css',
    'blocks/two-colomns/__brief/two-colomns__brief.css',
    'blocks/two-colomns/__main-text/two-colomns__main-text.css',
    'blocks/two-colomns/__paragraph/two-colomns__paragraph.css',
    'blocks/two-colomns/__span-accent/two-colomns__span-accent.css',
    'blocks/two-colomns/two-colomns.css',
